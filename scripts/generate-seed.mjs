  ...
  users: [
    {
      ...
      display_name: "عمر الشهراني",
      role: "treasurer",
    },
    {
      email: "founder@monolith.demo",
      password: "monolith2026",
      display_name: "مستور الشهراني",
      role: "founder",
    },
    {
      email: "member@monolith.demo",
      password: "monolith2026",
      display_name: "عوض العمري",
      role: "member",
    },
  ],
  stakeholders: [
    { name: "مستور الشهراني", role: "مؤسس ورئيس النادي", split_percentage: 35 },
    { name: "عمر الشهراني", role: "أمين الصندوق", split_percentage: 25 },
    { name: "عوض العمري", role: "قائد فريق التقنية", split_percentage: 20 },
    { name: "صندوق تشغيل الفعاليات", role: "مخصص تشغيلي", split_percentage: 15 },
    { name: "احتياطي الطوارئ", role: "مخصص احتياطي", split_percentage: 5 },
  ],
  audit: [
    {
      actor: "مستور الشهراني",
      action: "created",
    ...
    },
    {
      actor: "عمر الشهراني",
      action: "updated",
      change_description: "تعديل نسبة «مستور الشهراني»",
    ...
    },
    {
      actor: "مستور الشهراني",
      action: "updated",
      change_description: "تعديل نسبة «عوض العمري»",
      field: "split_percentage",
      old_value: "15",
      new_value: "20",
      offset_days: 41,
